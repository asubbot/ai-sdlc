...
main() {
  ...
  cp "${TEMPLATES}/.golangci.yml" "${PRODUCT}/.golangci.yml"
  mkdir -p "${PRODUCT}/scripts"
  cp "${TEMPLATES}/scripts/check-module-boundaries.sh" "${PRODUCT}/scripts/check-module-boundaries.sh"
  chmod +x "${PRODUCT}/scripts/check-module-boundaries.sh"
  mkdir -p "${PRODUCT}/.github/workflows"
  cp "${TEMPLATES}/.github/workflows/ci.yml" "${PRODUCT}/.github/workflows/ci.yml"
  ...
  assert_file ".golangci.yml"
  assert_file "scripts/check-module-boundaries.sh"
